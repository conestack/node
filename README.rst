...
Summary of the test coverage report::
    ...
    --------------------------------------------------------
    src/node/base.py                        29      0   100%
    src/node/behaviors/__init__.py          57      0   100%
    src/node/behaviors/adopt.py             44      0   100%
    src/node/behaviors/alias.py            104      0   100%
    src/node/behaviors/attributes.py        46      0   100%
    src/node/behaviors/cache.py             70      0   100%
    src/node/behaviors/common.py            92      0   100%
    src/node/behaviors/constraints.py       44      0   100%
    src/node/behaviors/context.py           39      0   100%
    src/node/behaviors/events.py           113      0   100%
    src/node/behaviors/fallback.py          46      0   100%
    src/node/behaviors/lifecycle.py         49      0   100%
    src/node/behaviors/mapping.py          136      0   100%
    src/node/behaviors/node.py              81      0   100%
    src/node/behaviors/nodespace.py         34      0   100%
    src/node/behaviors/order.py             53      0   100%
    src/node/behaviors/reference.py         84      0   100%
    src/node/behaviors/schema.py           158      0   100%
    src/node/behaviors/sequence.py          80      0   100%
    src/node/behaviors/storage.py           53      0   100%
    src/node/compat.py                      10      0   100%
    src/node/events.py                      32      0   100%
    src/node/interfaces.py                 131      0   100%
    ...
    src/node/schema/serializer.py           76      0   100%
    ...
    src/node/tests/__init__.py              99      0   100%
    src/node/tests/test_adopt.py            82      0   100%
    src/node/tests/test_alias.py           113      0   100%
    src/node/tests/test_attributes.py       53      0   100%
    src/node/tests/test_base.py            208      0   100%
    src/node/tests/test_cache.py            98      0   100%
    src/node/tests/test_common.py           82      0   100%
    src/node/tests/test_constraints.py      83      0   100%
    ...
    src/node/tests/test_mapping.py          70      0   100%
    src/node/tests/test_node.py             38      0   100%
    ...
    src/node/tests/test_sequence.py        135      0   100%
    src/node/tests/test_serializer.py      268      0   100%
    src/node/tests/test_storage.py          78      0   100%
